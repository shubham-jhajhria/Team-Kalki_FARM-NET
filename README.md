A base model for weeds (Unwanted plants) detection in crops which can be further integrated with Robots and Drones for picking out weeds and for density based mapping of weeds.
